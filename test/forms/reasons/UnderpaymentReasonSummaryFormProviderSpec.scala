...
class UnderpaymentReasonSummaryFormProviderSpec extends FormSpecBase {
  ...
  "Binding a form with invalid data" when {
    ...
    "the no value selected" should {
      ...
      "have an error with the correct message" in {
        form.errors.head.message mustBe "underpaymentReasonSummary.error.required"
      }
    }
  }
  ...
  "Binding a form with valid data" should {
    ...
    val form = new UnderpaymentReasonSummaryFormProvider()().bind(data)
