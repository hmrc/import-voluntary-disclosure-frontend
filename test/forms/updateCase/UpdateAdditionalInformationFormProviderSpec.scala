...
class UpdateAdditionalInformationFormProviderSpec extends FormSpecBase {
  ...
  "Binding a form with invalid data" when {
    ...
    "no data entered" should {
      ...
      "have an error with the correct message" in {
        form.errors.head.message mustBe "updateAdditionalInformation.error.required"
      }
    }
    ...
    "maxLength data entered" should {
      ...
      "have an error with the correct message" in {
        form.errors.head.message mustBe "updateAdditionalInformation.error.maxLength"
      }
    }
