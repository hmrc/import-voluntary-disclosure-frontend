...
class MoreDocumentationFormProviderSpec extends FormSpecBase {
  ...
  "Binding a form with invalid data" when {
    ...
    "the no value selected" should {
      ...
      "have an error with the correct message" in {
        form.errors.head.message mustBe "moreDocumentation.error.required"
      }
    }
  }
  ...
  "Binding a form with valid data" should {
    ...
    val form = new MoreDocumentationFormProvider()().bind(data)
