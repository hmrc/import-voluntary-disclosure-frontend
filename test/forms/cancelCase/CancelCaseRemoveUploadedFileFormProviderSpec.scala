...
class CancelCaseRemoveUploadedFileFormProviderSpec extends FormSpecBase {
  ...
  "Binding a form with invalid data" when {
    ...
    "with no value selected" should {
      ...
      "have an error with the correct message" in {
        form.errors.head.message mustBe "removeUploadedFile.cancelCase.error.required"
      }
    }
  }
  ...
  "Binding a form with valid data" should {
    ...
    val form = new CancelCaseRemoveUploadedFileFormProvider()().bind(data)
