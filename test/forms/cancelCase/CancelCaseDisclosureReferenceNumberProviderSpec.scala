...
class CancelCaseDisclosureReferenceNumberProviderSpec extends FormSpecBase {
  ...
  def formBinder(formValues: Map[String, String] = Map("value" -> "")): Form[String] =
    new CancelCaseDisclosureReferenceNumberFormProvider()().bind(formValues)
  ...
  "Binding a form with invalid data" when {
    ...
    "with no data present" should {
      ...
      "have an error with the correct message" in {
        form.errors.head.message mustBe "cancelCase.disclosureReference.error.required"
      }
    }
    ...
    "with invalid format" should {
      ...
      "have an error with the correct message" in {
        form.errors.head.message mustBe "cancelCase.disclosureReference.error.format"
      }
    }
  }
