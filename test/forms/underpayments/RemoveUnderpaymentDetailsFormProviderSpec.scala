...
class RemoveUnderpaymentDetailsFormProviderSpec extends FormSpecBase {
  ...
  "Binding a form with invalid data" when {
    ...
    "with no value selected" should {
      ...
      "have an error with the correct message" in {
        form.errors.head.message mustBe "removeUnderpaymentDetails.B00.error.message"
      }
    }
  }
  ...
  "Binding a form with valid data" should {
    ...
    val form = new RemoveUnderpaymentDetailsFormProvider()(underpaymentType).bind(data)
