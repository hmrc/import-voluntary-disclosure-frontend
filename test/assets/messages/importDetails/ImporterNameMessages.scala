...
object ImporterNameMessages extends BaseMessages {
  ...
  val hint: String =
    "This should match the name as it appears on the import declaration (also known as the C88 or Single Administrative Document (SAD)). If you are representing an individual then enter their full name."
