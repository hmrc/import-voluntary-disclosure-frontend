...
object RepresentativeConfirmationMessages extends BaseMessages {
  ...
  val p1BulkEntryEoriExists = "We have received your disclosure of underpaid Customs Duty or import VAT on multiple entries. All of these entries were for goods imported by Test User, EORI number GB123456789."
  val p1BulkEntryNoEori = "We have received your disclosure of underpaid Customs Duty or import VAT on multiple entries. All of these entries were for goods imported by Test User."
