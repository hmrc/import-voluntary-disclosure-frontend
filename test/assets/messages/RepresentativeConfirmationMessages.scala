...
object RepresentativeConfirmationMessages extends BaseMessages {

  val pageTitle       = "Confirmation screen"
  val heading         = "Disclosure sent"
  val referenceNumber = "Disclosure reference number:"
  val p1SingleEntry =
    "We have received your disclosure of underpaid Customs Duty or import VAT for the import declaration 123-123456Q-01/01/2021."
  val p1BulkEntryEoriExists =
    "We have received your disclosure of underpaid Customs Duty or import VAT on multiple entries. All of these entries were for goods imported by Test User, EORI number GB123456789."
  val p1BulkEntryNoEori =
  ...
  val p2OtherPayment =
    "We will check the information you have provided and send you a C18 Post Clearance Demand Note in the post, usually within 10 days. " +
      "We will also send a copy to Test User using the address you have provided."
  val p3OtherPayment =
    "The demand note will tell you how to pay. Payment must be made within 10 days of receiving the demand note."
  val p4OtherPayment =
