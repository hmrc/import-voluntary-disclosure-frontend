...
object IndividualHandoffMessages extends BaseMessages {
  ...
  val p2_1 = "You need to contact us on the email address"
  val p2_2 = "and give brief details. We will take you through the process of paying the tax or duty that is owed."
