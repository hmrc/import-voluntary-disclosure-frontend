...
object IndividualContinueWithCredentialsMessages extends BaseMessages {
  ...
  val title         = "Are you sure you want to use these sign in details to set up access to the service?"
  val legend        = "Ensure you have signed in with the HMRC online details you use for your business."
