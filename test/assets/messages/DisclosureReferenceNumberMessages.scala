...
object DisclosureReferenceNumberMessages extends BaseMessages {
  ...
  val details = "You will need to email us at customsaccountingrepayments@hmrc.gov.uk with the entry details, the EORI number and name of the importer, and the information you want to add to the disclosure."
  val mailLink = "mailto:customsaccountingrepayments@hmrc.gov.uk"
