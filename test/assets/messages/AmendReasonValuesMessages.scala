...
object AmendReasonValuesMessages extends BaseMessages {
  ...
  val boxContent: Map[BoxNumber, ExpectedContent] = Map(
    ...
    BoxNumber.Box45 -> ExpectedContent("Box 45 adjustment amendment for item 1",
      "Box 45 adjustment amendment for item 1",
      Some("This is usually a letter followed by a number, sometimes the letter or number may be on its own, for example A12.5, D0, M or 4.5.")),
