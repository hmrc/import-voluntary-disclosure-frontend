...
object AcceptanceDateBulkMessages extends BaseMessages {
  ...
  val h1: String = "When were the entry acceptance dates for all the entries?"
  val info: String = "You must not include entries where some have an entry acceptance date before and some after 1 January 2021. If the entries cross this date you will need to separate them and make two disclosures."
