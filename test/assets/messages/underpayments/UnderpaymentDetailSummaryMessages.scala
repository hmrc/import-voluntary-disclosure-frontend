...
object UnderpaymentDetailSummaryMessages extends BaseMessages {
  ...
  val radioMessageHintSingleEntry =
    "You must tell us about all the duty or tax that was underpaid on the original import declaration."
  val radioMessageHintBulkEntry =
    "You must tell us about all the duty or tax that was underpaid on the original import declarations."
  val fullList =
    "You cannot add any more underpayment details as you have selected all the possible tax or duty that can apply to an import declaration."
