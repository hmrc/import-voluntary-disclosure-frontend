...
class CYASummaryListHelperSpec
  ...
  trait Test {
    ...
    val userAnswers: UserAnswers = UserAnswers("some-cred-id")
      ...
      .success
      .value
      .set(TraderAddressPage, ContactAddress("21 Street", Some("Mayfair"), "London", Some("SN6PY"), "UK"))
      .success
      .value
      ...
      .success
      .value
      .set(ImporterAddressPage, ContactAddress("21 Street", Some("Mayfair"), "London", None, "UK"))
      .success
      .value
      .set(UnderpaymentDetailSummaryPage, Seq(UnderpaymentDetail("B00", 0.0, 1.0)))
      .success
      .value
      .set(
  ...
  "buildUnderpaymentDetails" should {
    ...
    "produce a valid model when all answers are provided for multiple entries" in new Test {
      override val userAnswers: UserAnswers = UserAnswers("")
        ...
        .success
        .value
        .set(MoreInformationPage, "Stock losses in warehouse across multiple entries.")
        .success
        .value
