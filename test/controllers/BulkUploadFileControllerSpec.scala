...
//import views.html.{BulkUploadFileView, UploadFileView, UploadProgressView}
//
...
//        mockFileUploadRepository, mockSessionRepository, mockUpScanService, bulkUploadFileView, uploadProgressView, form, MockAppConfig)
//    }
//  }
//
