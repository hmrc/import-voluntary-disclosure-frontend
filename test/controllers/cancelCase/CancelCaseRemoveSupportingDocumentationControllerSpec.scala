...
class CancelCaseRemoveSupportingDocumentationControllerSpec extends ControllerSpecBase with BeforeAndAfterAll {

  val mockSessionRepository: SessionRepository = mock[SessionRepository]

  val cancelCaseRemoveUploadedFileView: CancelCaseRemoveUploadedFileView =
  ...
  def controller(ua: Option[UserAnswers] = userAnswers): CancelCaseRemoveSupportingDocumentationController = {
    new CancelCaseRemoveSupportingDocumentationController(
      messagesApi,
