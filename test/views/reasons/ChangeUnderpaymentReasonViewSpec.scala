    ...
    "showing underpayment with item number" should {
      ...
      "have correct item number value" in {
        document
          ...
          .eachText
          .get(0) mustBe singleItemReason.original.itemNumber.toString
      }
      ...
      "have correct original amount title" in {
        document
          ...
          .eachText
          .get(1) mustBe ChangeUnderpaymentReasonMessages.originalValue
      }
    ...
    "showing underpayment without item number" should {
      ...
      "have correct original amount title" in {
        document
          .select(".govuk-summary-list__key")
          .eachText
          .get(0) mustBe ChangeUnderpaymentReasonMessages.originalValue
      }
