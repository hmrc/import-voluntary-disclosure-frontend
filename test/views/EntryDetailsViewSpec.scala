  ...
  "Rendering the Entry Details view" when {
    ...
    "page for the importer" should {
      ...
      "contain the expected top paragraph" in {
        elementText("#main-content p:nth-of-type(1)") mustBe EntryDetailsMessages.paragraphWhenImporter
      }
    }
    ...
    "page for the representative" should {
      ...
      "contain the expected top paragraph" in {
        elementText("#main-content p:nth-of-type(1)") mustBe EntryDetailsMessages.paragraph
      }
    }
  }
