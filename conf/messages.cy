...
confirmation.whatHappensNext.deferment.p2 = We will check the information you have provided and process the payment using the deferment account details you have provided. We will then send you a C18 Post Clearance Demand Note in the post, usually within 10 working days.
...
confirmation.whatYouShouldDoNext.link = Start a new, add to, or cancel a disclosure
...
cya.myDefermentAccount = My deferment account (A)
cya.importerAuthority = The importer’s account and I have authority to use it (B)
cya.importerStandingAuthority = The importer’s account and I have standing authority to use it (C)
...
importerName.hint = This should match the name as it appears on the import declaration (also known as the C88 or Single Administrative Document (SAD)). If you are representing an individual then enter their full name.
...
underpaymentStart.details.header = If {0} uses postponed VAT accounting (PVA)
underpaymentStart.details.representative.p1 = Do not use this service to tell us about underpaid import VAT if {0} uses postponed VAT accounting. They must account for the underpaid import VAT on their next VAT return.
underpaymentStart.details.importer.p1 = Do not use this service to tell us about underpaid import VAT if {0} uses postponed VAT accounting. You must account for the underpaid import VAT on your next VAT return.
...
repDan.radio1 = My deferment account (A)
repDan.radio2 = The importer’s account and I have authority to use it (B)
repDan.radio2.hint = You will be asked to upload proof of authority
repDan.radio3 = The importer’s account and I have standing authority to use it (C)
